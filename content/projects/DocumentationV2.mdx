...
## User Guide  
- **Use the Components**: Drag and drop the components into your Grasshopper canvas.  
- **Read the Input and Output Options**: Each component provides specific inputs, outputs, and options that you can use to control the data processing.
- **Export Results**: Components like **Export as CSV** allow you to save your processed data for further analysis outside of Grasshopper.

---

## License  
PelicanFlow_Data is licensed under the MIT License. See LICENSE for more details.
